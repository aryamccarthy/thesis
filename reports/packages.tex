...
%\usepackage[chapter]{algorithm}       % TCM Algorithm block See http://algorithms.berlios.de/ % ADM Chapter numbering
...
\usepackage[detect-all]{siunitx}		 % TCM package required to ensure units are typeset properly with numbers e.g. \SI{10}{\kg\m\per\square\s}
...
% Arya's Packages
%===========================================================
\usepackage{tgpagella}		 		  % ADM Let's use Palatino. It really classes up this whole affair.
